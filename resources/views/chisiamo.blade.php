    ...
    <nav class="navbar navbar-expand-lg bg-light py-3">
      ...
      <div class="container">
        <div class="row flex-wrap">
            <div class="col-12">
                <h2 class="text-center display-2">Chi Siamo</h2>
            </div>
            @foreach($fondatori as $fondatore)
            <div class="col-12 col-md-4">
                <div class="card my-5">
                    <img class="img-fluid" src="{{$fondatore['img']}}" class="card-img-top" alt="...">
                    <div class="card-body">
                      <h5 class="card-title">{{$fondatore["name"]}}</h5>
                      <h5 class="card-title">{{$fondatore["surname"]}}</h5>
                      <a href="{{route('descrizioneRuolo',['idRole'=>$fondatore['id']])}}" class="btn btn-primary">Scopri il ruolo</a>
                    </div>
                  </div>
            </div>
            @endforeach
