...
<html lang="en">
  ...
  <body>
    <nav class="navbar navbar-expand-lg bg-light py-3 navbar-custom fixed-top">
    ...
    <header>
        <section class="container-fluid vh-100 container-header d-flex align-items-center justify-content-center">
            <div class="row">
                <div class="col-12">
                    <a class="a-h1" href="#proposte"><h1 class="text-center display-1 h1-header">Benvenuti nel sito di Artisan Viaggi</h1></a>
                </div>
            </div>
        </section>
    </header>
    ...
    <main>
        <div class="container" id="proposte">
